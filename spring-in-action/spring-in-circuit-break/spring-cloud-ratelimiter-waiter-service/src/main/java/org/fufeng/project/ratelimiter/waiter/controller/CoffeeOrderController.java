package org.fufeng.project.ratelimiter.waiter.controller;

import io.github.resilience4j.ratelimiter.RateLimiter;
import io.github.resilience4j.ratelimiter.RateLimiterRegistry;
import io.github.resilience4j.ratelimiter.RequestNotPermitted;
import lombok.extern.slf4j.Slf4j;
import org.fufeng.project.ratelimiter.waiter.controller.request.NewOrderRequest;
import org.fufeng.project.ratelimiter.waiter.model.Coffee;
import org.fufeng.project.ratelimiter.waiter.model.CoffeeOrder;
import org.fufeng.project.ratelimiter.waiter.service.CoffeeOrderService;
import org.fufeng.project.ratelimiter.waiter.service.CoffeeService;
