package org.fufeng.project.lazy.customer.controller;
...
import org.fufeng.project.lazy.customer.integration.CoffeeOrderService;
import org.fufeng.project.lazy.customer.integration.CoffeeService;
import org.fufeng.project.lazy.customer.model.*;
...
public class CustomerController {
    ...
    public List<Coffee> readMenu() {
        return Try.ofSupplier(
                ...
                .recover(RequestHandlerCircuitBreakerAdvice.CircuitBreakerOpenException.class, Collections.emptyList())
