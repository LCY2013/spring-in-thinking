package org.fufeng.springnative.bfpp;
...
import static org.fufeng.springnative.bfpp.BfppConfiguration.BEAN_NAME;
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        if (!registry.containsBeanDefinition(BEAN_NAME))
            registry.registerBeanDefinition(BEAN_NAME,
                    BeanDefinitionBuilder.rootBeanDefinition("org.fufeng.springnative.bfpp.Listener").getBeanDefinition());
    }
