 ...
 */
public class AnnotatedBeanDefinitionParsing implements BeanNameAware {
    ...
    public static void main(String[] args) {
        ...
        //重新定义beanName生成策略
        definitionReader.setBeanNameGenerator((definition,registry)-> Math.random()+"");
        ...
        AnnotatedBeanDefinitionParsing annotatedBeanDefinitionParsing =
                beanFactory.getBean(AnnotatedBeanDefinitionParsing.class);
